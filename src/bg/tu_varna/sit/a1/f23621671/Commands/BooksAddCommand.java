...
public class BooksAddCommand implements Command{
    ...
    public void runCommand(String input) {
        ...
        Book book=new Book.BookBuilder(author,title,genre,isbn).withBookDescription(description).withBookYear(Integer.parseInt(year)).withRating(Float.parseFloat(rating)).witTags(tags).build();
