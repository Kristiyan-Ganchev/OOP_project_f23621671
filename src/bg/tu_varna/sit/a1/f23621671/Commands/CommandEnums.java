...
public enum CommandEnums {
    ...
    SAVE("save", 0, "save\t\t\t  saves the currently open file",AccessLevel.NONE, false),
    SAVE_AS("save as", 1, "save as <file>\t  saves the currently open file in <file>",AccessLevel.NONE, false),
